			...
			<div class="container">	
				<div class="col-md-12">
					<div class="product col-md-3 service-image-left">
							...
							<img id="item-display" style="Height:100px;width:125px;" src="./resources/image/${product.proImage}" alt="Please Select Any Product" width="350" height="350"></img>
				...
				<div class="col-md-7">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="hidden" required  name="id" value="${product.prodId}"  onkeyup="sum();"/><br><br>
					ProductPrice:&nbsp;&nbsp;&nbsp;
					<input type="text" id="txt1" name="prodprice" value="${product.prodPrice}" readonly onkeyup="sum();"/><br><br>
					ProductQuantity:<input required type="text" id="txt2" name="q" value="" onkeyup="sum();"/>
