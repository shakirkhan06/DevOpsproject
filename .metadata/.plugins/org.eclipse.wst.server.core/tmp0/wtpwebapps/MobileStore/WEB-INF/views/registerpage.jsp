...
<form action="registerpage">
  ...
  <tr>
    ...
    <input type="text" placeholder="Enter UserID" pattern="[0-9]+" name="uid" required><td>
    </tr><tr>
    <td>
    <label><b>Name</b></label></td><td>
    <input type="text" placeholder="Enter Name" pattern="[a-zA-A][a-zA-Z0-9-_\.]{1,20}$" name="username" required><td>
   </tr>
    <tr>
    <td>
    ...
    <input type="radio" name="gen" required/>M<input type="radio" name="gen" required/>F</td>
    </tr>
    <tr>
    <td>
