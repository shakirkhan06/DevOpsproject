...
<body>
	...
	<div id="addcat">
		<form id="myform" action="category">
			...
			<div class="container1">
				<label><b>Category Id</b></label> <input type="text" name="cId"
					value="" style="width: 350px; display: block;"> <label><b>Category
						Name</b></label> <input type="text" name="cn" value=""
					style="width: 350px; display: block;"> <input type="submit"
					id="myBtn" value="Add" onclick="dialog()"> <input
	...
	<div id="addsup">
		...
		<form action="supplier" id="form_purge" name="form_purge">
			<div class="container">
				<label><b>Supplier Id</b></label> <input type="text" name="sId"
					value="" style="width: 350px; display: block;"> <label><b>Supplier
						Name</b></label> <input type="text" name="sn" value=""
					style="width: 350px; display: block;"> <input type="submit"
					id="myBtn" value="Add">
