...
<h2>SHIPPING DETAILS</h2>
  ...
  <table class="table">
    ...
    <tbody>
      <tr>
        <td>${summaryDetails.name}</td>
        <td>${summaryDetails.email}</td>
        <td>${summaryDetails.contact}</td>
        <td>${summaryDetails.address}</td>
        <td>${summaryDetails.date}</td>
      </tr>
      
    </tbody>
  </table>
  <a href="thankYou">Success</a><a Href="customerdetails">Back</a>
</div>
	<hr>
 <div class="container">
<center><h4>Subscribe@SocialNetwork</h4>
    <hr />
