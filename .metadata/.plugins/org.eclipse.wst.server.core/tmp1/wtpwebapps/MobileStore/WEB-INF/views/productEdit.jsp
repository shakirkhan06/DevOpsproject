...
<hr/>
  <form action="product_update"  method="post"  enctype="multipart/form-data">
    <div class="form-group">
      ...
      <input type="number" class="form-control" required id="p_id" placeholder="Enter Product ID" name="p_id" value="${product.prodId}">
    </div>
    <div class="form-group">
      <label for="p_name">Product Name :</label>
      <input type="text" class="form-control" required id="p_name" placeholder="Enter Product Name " name="p_name" value="${product.prodName}">
    </div>
    <div class="form-group">
      <label for="p_desc">Product Description :</label>
      <input type="text" class="form-control" required id="p_desc" placeholder="Enter Product Description " name="p_desc"value="${product.prodDescription}" >
    </div>
    <div class="form-group">
      <label for="p_price">Product Price :</label>
      <input type="number" class="form-control" required id="p_price" placeholder="Enter Product Price " name="p_price"value="${product.prodPrice}" >
    </div>
    <div class="form-group">
